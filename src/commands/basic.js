...
const HELP_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      ['`/top репутация`', 'топ по репутации'],
      ['`/top сообщения`', 'топ по сообщениям'],
  ...
  },
  {
    id: 'automod',
    label: '🛡️ AutoMod',
    description: 'Автомодерация, анти-спам, анти-рейд',
    commands: [
      ['`/automod статус`', 'текущие настройки автомода'],
      ['`/automod включить`', 'включить автомодерацию'],
      ['`/automod выключить`', 'выключить автомодерацию'],
      ['`/automod настроить`', 'изменить параметры фильтров'],
      ['`/automod модераторы`', 'репутация модераторов'],
      ['`/automod предупреждения`', 'предупреждения пользователя']
    ]
  },
  {
    id: 'logs',
    label: '📋 Логирование',
    description: 'Логи сервера, аудит модераторов',
    commands: [
      ['`/logs канал`', 'установить канал для логов'],
      ['`/logs включить`', 'включить логирование'],
      ['`/logs выключить`', 'выключить логирование'],
      ['`/logs последние`', 'просмотреть последние логи'],
      ['`/logs модстатс`', 'статистика модераторов'],
      ['`/logs аудит`', 'аудит действий модератора']
    ]
  },
  {
    id: 'welcome',
    label: '👋 Приветствия',
    description: 'Приветствия, прощания, авто-роли',
    commands: [
      ['`/welcome статус`', 'текущие настройки'],
      ['`/welcome включить`', 'включить приветствия'],
      ['`/welcome приветствие`', 'канал приветствий'],
      ['`/welcome прощание`', 'канал прощаний'],
      ['`/welcome текст`', 'текст приветствия'],
      ['`/welcome авторо`', 'добавить авто-роль'],
      ['`/welcome гайд`', 'гайд для новичков в ЛС']
    ]
  },
  {
    id: 'cards',
    label: '🃏 Карточки',
    description: 'Коллекционные карточки, обмен, крафт',
    commands: [
      ['`/cards купить`', 'купить набор карточек'],
      ['`/cards коллекция`', 'посмотреть коллекцию'],
      ['`/cards альбомы`', 'прогресс альбомов'],
      ['`/cards обменять`', 'обмен карточками'],
      ['`/cards крафт`', 'объединить 3 карты в карту выше']
    ]
  },
  {
    id: 'titles',
    label: '🏷️ Титулы',
    description: 'Титулы, ранги и кастомные звания',
    commands: [
      ['`/titles список`', 'все доступные титулы'],
      ['`/titles мои`', 'разблокированные титулы'],
      ['`/titles установить`', 'активировать титул'],
      ['`/titles купить`', 'купить кастомный титул'],
      ['`/titles сбросить`', 'убрать активный титул']
    ]
  }
];
